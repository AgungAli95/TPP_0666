                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-info">
                            ...
                            <form class="form-horizontal" action="../module/pesanan/aksi_edit.php" method="POST">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="status" id="status">
                                                <option value="<?= $rowEdit['status_order']; ?>"><?= $status; ?>
                                                </option>
                            ...
                            <div class="box-body">
                                <div class="table-responsive">
                                    <table class="table no-margin">
                                        ...
                                        <tbody>
                                            <?php
                                    $QueryCart = mysqli_query($koneksi, "SELECT * FROM tbl_detail_order do INNER JOIN tbl_order o ON do.id_order = o.id_order INNER JOIN tbl_barang p ON o.id_barang = p.id_barang WHERE do.invoice = '$invoice'");
                                    while ($row = mysqli_fetch_array($QueryCart)) {
                                    ?>
                                            <tr>
                                                <td class="cart_product" style="margin: 10px 20px">
                                                    <img src="<?= $base_url; ?>admin/upload/<?= $row['foto_barang'] ?>"
                                                        width="150">
                                                </td>
                                                ...
                                                <td class="cart_total">
                                                    <p class="cart_total_price">Rp
                                                        <?= number_format($row['harga_barang'] * $row['jumlah']) ?>
                                                    </p>
                                                </td>
                                            </tr>
                                            <?php } ?>
