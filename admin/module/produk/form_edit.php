            ...
            <div class="col-md-12">
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" action="../module/produk/aksi_edit.php" method="POST" enctype="multipart/form-data">
                        <input type="hidden" class="form-control" name="id_barang" value="<?= $id_produk; ?>">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label>
                                            <input type="radio" name="slide" value="Y">Ya
                                        </label>
                                        <label>
                                            <input type="radio" name="slide" value="N">No
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio">
                                        ...
                                        <label>
                                            <input type="radio" name="rekomendasi" value="N">No
                                        </label>
                                    </div>
                                </div>
                            </div>
